...
const linkedIn = () => {
	...
	window.location =
		"https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=77qh8odc5i852h&redirect_uri=https%3A%2F%2Fone-fm-job-application-portal.vercel.app%2Fform.html&scope=r_fullprofile%20r_emailaddress";
};
const getLinkedInData = async () => {
	...
	// };
	axios
		.post("https://linked-be.marzooq703.vercel.app/api/accessCode", { code })
		.then((result) => {
			console.log(result);
		})
		.catch((err) => {
